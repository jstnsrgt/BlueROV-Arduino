...
void TelstraIoT::Construct(const char* _host, const int _port, const char* _tenantId, const char* _user, const char* _password, const char* _applicationKey, Connection4G* conn, IoTShield* shield) {
    credentialsSet = true;
	host = _host;
    port = _port;
    tenantId = _tenantId;
...
TelstraIoT::TelstraIoT(Connection4G* conn, IoTShield* shield) {
	credentialsSet = false;
	this->conn = conn;
	this->shield = shield;
}

TelstraIoT::TelstraIoT(const char* host, const int port, const char* tenantId, const char* user, const char* password, const char* applicationKey, Connection4G* conn, IoTShield* shield) {
    Construct(host, port, tenantId, user, password, applicationKey, conn, shield);
}

TelstraIoT::TelstraIoT(const char* host, const char* tenantId, const char* user, const char* password, const char* applicationKey, Connection4G* conn, IoTShield* shield) {
