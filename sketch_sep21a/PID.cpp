...
PID::PID(Data * dPtr) : Control(dPtr) {
    pGainRoll = 0.3; 		//set the gain for the PID speed based on the level correction changes
    pGainPitch = 0.3; 	// "
    pGainYaw = 0.7; 		// "
    dGainRoll = 1; 		// "
    dGainPitch = 1; 		// "
    dGainYaw = 2; 		// "
    pGainDepth = 1; 		//set the gain for the PID speed based on the vertical equilibrium changes
    dGainDepth = 2; 
